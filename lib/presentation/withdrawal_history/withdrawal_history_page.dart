...
class WithdrawalHistoryPage extends BaseStatefulPage<WithdrawalHistoryController> {
  const WithdrawalHistoryPage({super.key});

  @override
  BaseStatefulPageState<WithdrawalHistoryController> createState() =>
      _WithdrawalHistoryPageState();
}

class _WithdrawalHistoryPageState
    extends BaseStatefulPageState<WithdrawalHistoryController> {

  @override
  void setupAdditionalListeners() {
    super.setupAdditionalListeners();
    if (kDebugMode) {
      print('Withdrawal History - Additional listeners setup');
    }
  }
