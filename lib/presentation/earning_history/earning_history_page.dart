...
class EarningHistoryPage extends BaseStatefulPage<EarningHistoryController> {
  const EarningHistoryPage({super.key});

  @override
  BaseStatefulPageState<EarningHistoryController> createState() =>
      _EarningHistoryPageState();
}

class _EarningHistoryPageState
    extends BaseStatefulPageState<EarningHistoryController> {
  @override
  void setupAdditionalListeners() {
    super.setupAdditionalListeners();
    if (kDebugMode) {
      print('Earning History - Additional listeners setup');
    }
  }
