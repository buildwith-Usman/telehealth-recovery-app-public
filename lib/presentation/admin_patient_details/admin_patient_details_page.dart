...
class AdminPatientDetailsPage
    extends BaseStatefulPage<AdminPatientDetailsController> {
  const AdminPatientDetailsPage({super.key});

  @override
  BaseStatefulPageState<AdminPatientDetailsController> createState() =>
      _AdminPatientDetailsPageState();
}

class _AdminPatientDetailsPageState
    extends BaseStatefulPageState<AdminPatientDetailsController> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              gapH20,
              // Expanded Tab Layout with dynamic tabs from config
              Expanded(
